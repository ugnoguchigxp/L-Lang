# Semantic TypeScript guide

[Overview](../../README.en.md) · [日本語](./semantic-typescript.md) · [Input/output routes](./language-routes.md) (Japanese)

This guide covers the TypeScript DSL, restricted IR resolution, and ordinary TypeScript output. This route coexists with JSONC. The implementation scope, limitations, locks, and evidence below refer to Semantic TypeScript. Run commands from the repository root.
...
- The `semantic` CLI in this guide emits TypeScript. See the [route guide](./language-routes.md) for Wasm and JSONC workflows. No LSP or general-purpose custom runtime is provided.
